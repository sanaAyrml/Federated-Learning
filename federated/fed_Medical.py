...
def prepare_data(args,c_num):
    ...
    if args.mode == 'virtual_data':
        ...
        anchor_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([anchor_dataset, anchor_dataset, anchor_dataset]), batch_size=args.batch, shuffle=False)
